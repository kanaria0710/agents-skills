...
- Unclosed quotes
- Invalid YAML syntax
**Solution**: Check frontmatter against `references/frontmatter-spec.md`
...
**Fix**: Revise description field. Add more detail, specific trigger phrases, and keywords for technical terms.
...
4. **Model laziness**
   Add explicit encouragement to the skill or suggest users add to their prompts:
   ```
   ## Performance Notes
...
1. Verify MCP server is connected
   - Claude.ai: Settings > Extensions > [Service]
